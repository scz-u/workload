      ...
      <div class="content">
        <div class="content_title">
          ...
          <p class="before_font display_inline_block">
            审批流程中包含{{ this.$store.state.username }}的任务列表
          </p>
        </div>
            ...
            >
              <div class="item_list_img">
                ...
                <div class="p_font_fill_content">
                  ...
                  ></i>
                  <p class="p_over display_inline_block width_140">
                ...
                <div class="p_font_fill_content">
                  ...
                  ></i>
                  <p class="p_over display_inline_block width_120">
