        ...
        <el-row>
          <el-col :span="18">
            <el-button
              ...
              >添加成员</el-button
            >
            <el-dropdown trigger="click" class="margin_l_5">
              <el-button size="small" round icon="el-icon-sort">
                批量导入/导出
              ...
              <el-dropdown-menu slot="dropdown">
                  ...
                  <p>
                    <router-link
                      :to="{
                        ...
                        query: { name: fileName, k: selectFile.data.depart_id },
                      }"
                    >
                      批量导入
                    </router-link>
                ...
                <el-dropdown-item
                  ><p @click="downexcel_depart()">批量导出</p></el-dropdown-item
                >
              </el-dropdown-menu>
            </el-dropdown>
  ...
  methods: {
    ...
    delClick () {
      ...
      for (let i = 0, max = this.dellist.length; i < max; i++) {
        userlist.push(this.dellist[i].u)
      }
