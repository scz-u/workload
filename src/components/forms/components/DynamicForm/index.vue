        ...
        <el-tabs v-model="activeTabName" :stretch="true">
          <el-tab-pane label="常用组件" name="common">
            <div class="components-list">
              ...
              >
                ...
                >
                  <div class="components-body">
                    ...
                    <div class="img_div">
                      <!-- <i class="iconfont icon-img2"></i> -->
                      <!-- <svg :icon-class="element.tagIcon" /> -->
                      <img
                        :src="
              ...
              <p class="component_title">其他控件</p>
  ...
  methods: {
    stringComponent () {
      ...
      for (let i in this.drawingList) {
        ...
        let code = ''
        if (this.drawingList[i].idx <= 26) {
          code = String.fromCharCode(64 + this.drawingList[i].idx)
        }
        else if (this.drawingList[i].idx > 26 && this.drawingList[i].idx <= 52) {
          code = 'A' + String.fromCharCode(64 + this.drawingList[i].idx - 26)
        }
        console.log(code)
        stringC.push({ Name: this.drawingList[i].label, Is: this.drawingList[i].enable_assign == true ? false : true, C: this.drawingList[i].tagIcon, Idx: this.drawingList[i].idx, Code: code })
        strlist.code.push(code)
        ...
        if (this.formData.fields[i].tagIcon == 'calculate' && this.formData.fields[i].strlist.length == 0) {
          ...
          if (this.formData.fields[i].options.length == 0) {
            ...
            for (let j in this.formData.fields[i].options) {
              ...
              if (this.formData.fields[i].tagIcon == 'select_number') {
                this.formData.fields[i].options[j].value = parseFloat(this.formData.fields[i].options[j].value)
              }
            }
          }
        }
