                ...
                <li>
                  ...
                  >
                    <ul class="dropdown_ul">
                      ...
                      <!-- <li @click="gorCopyClick(items.Code)">预览</li> -->
                      <li @click="gorFormClick(items.Code)">预览</li>
                      ...
                      <li @click="authorizationFormClick(items)">表单授权</li>
                      <!-- <li>sdf</li> -->
                      <!-- <li>sdf</li> -->
                    </ul>
                    <div class="clearfix"></div>
...
export default {
  ...
  methods: {
    ...
    getalltemplateform () {
      ...
      let createvalue = $this.$createObj(payload);
      var keyvalue = createvalue['keyvalue'];
      let posturl = $this.$apilist['getallformbytypeid'] + '?signature=' + keyvalue;
      // return false;
      console.log(payload)
      $this.$server.post(posturl, createvalue['fd']).then((data) => {
        console.log(data)
