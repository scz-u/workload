<template>
  <div class="form_list">
    <div v-if="!is_more">
      <div class="top_form">
        <span class="name_span">表单列表</span>
        <span class="right">
                    ...
                    <li>
                      ...
                      >
                        <ul class="dropdown_ul">
                          ...
                          <li @click="authorizationFormClick(items)">
                            表单授权
                          </li>
                          <!-- <li>sdf</li> -->
                          <!-- <li>sdf</li> -->
...
export default {
  ...
  methods: {
    ...
    getalltemplateform () {
      ...
      let createvalue = $this.$createObj(payload);
      var keyvalue = createvalue['keyvalue'];
      let posturl = $this.$apilist['getalltemplateform'] + '?signature=' + keyvalue;
      // return false;
      $this.$server.post(posturl, createvalue['fd']).then((data) => {
        console.log(data)
