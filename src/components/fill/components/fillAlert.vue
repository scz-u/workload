...
export default {
  ...
  components: { AssignAlert, uploadImg, uploadFile },
  data () {
    return {
      form_data1: {},
      my_is_add: false,
...
.fill_alert_dialog {
  ...
  .el-form--label-top .el-form-item__label span,
  .el-form--label-top .el-form-item__label i {
    padding: 0;
    font-weight: bold;
  }
