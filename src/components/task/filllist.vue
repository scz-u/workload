    ...
    <div v-if="!is_more">
      <div class="top_form">
        <!-- <el-button
          ...
          >添加</el-button
        >
        <el-button icon="el-icon-plus" size="small" @click="addListClick()"
          >提交</el-button
        > -->
        <span class="name_span"> {{ $route.query.formname }}</span>
        <div class="right">
          <el-input
            placeholder="搜索用户名"
            size="small"
          ...
          <el-button
            ...
            size="small"
            @click="gourl()"
            v-if="$route.params.other != 3 && $route.params.other != '3'"
            >批量导入</el-button
          >
          <el-button
            icon="el-icon-delete"
        ...
        <!-- <router-link
          :to="{
            name: 'gatherTask',
            params: { other: $route.query.other },
            query: {
...
export default {
  ...
  methods: {
    goback () {
      this.$router.push({
        name: 'gatherTask',
        // params: { other: this.$route.query.other },
        query: {
          id: this.$route.query.taskcode,
    ...
    gourl () {
      this.$router.push({ name: 'importTask', params: { other: this.$route.params.other }, query: { id: this.$route.query.id, taskcode: this.$route.query.taskcode, name: this.$route.query.name } })
    },
    goimg (key) {
      let $this = this
      let payload = {
