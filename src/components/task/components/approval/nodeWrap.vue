...
export default {
  ...
  mounted () {
    ...
    if (this.nodeConfig.type == 1) {
      ...
      console.log('sdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsdfsf')
      for (var i = 0; i < this.nodeConfig.conditionNodes.length; i++) {
        ...
        this.nodeConfig.conditionNodes[i].error = (i != this.nodeConfig.conditionNodes.length - 1 && this.nodeConfig.conditionNodes[i].nodeUserList.length > 0) ? false : true
        if (i == this.nodeConfig.conditionNodes.length - 1) {
          this.nodeConfig.conditionNodes[i].error = false
        }
      }
    }
  },
  methods: {
    ...
    saveCondition () {
      ...
      for (var i = 0; i < this.conditionsConfig.conditionNodes.length; i++) {
        console.log(this.conditionsConfig.conditionNodes[i])
        ...
        this.conditionsConfig.conditionNodes[i].error = (i != this.conditionsConfig.conditionNodes.length - 1 && this.conditionsConfig.conditionNodes[i].nodeUserList.length > 0) ? false : true
        if (i == this.conditionsConfig.conditionNodes.length - 1) {
          this.conditionsConfig.conditionNodes[i].error = false
        }
      }
      console.log('----------------')
    ...
    saveApprover () {
      ...
      console.log('9999999999999888888888888888888888888')
    ...
    sureCondition () {
      ...
      //1.弹窗有，外面无+
      //2.弹窗有，外面有不变
      console.log(this.conditionConfig.conditionList)
      if (this.conditionConfig.conditionList == undefined) {
    ...
    conditionStr (item, index) {
      ...
      if (conditionList == undefined || conditionList.length == 0) {
        console.log(this.nodeConfig.conditionNodes)
    ...
    addTerm () {
      ...
      console.log('qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqwwwwwwwwwwwwwwwwwwwwwwwwww')
      for (var i = 0; i < this.nodeConfig.conditionNodes.length; i++) {
        this.nodeConfig.conditionNodes[i].error = this.conditionStr(this.nodeConfig.conditionNodes[i], i) == "请设置条件" && i != this.nodeConfig.conditionNodes.length - 1 && this.nodeConfig.conditionNodes[i].nodeUserList.length == 0
      }
    ...
    setPerson (priorityLevel) {
      ...
      if (type == 0) {
        ...
        this.departlist_m = []
        for (let i in this.nodeConfig.nodeUserList) {
          // this.departlist_m.push({ id: this.nodeConfig.nodeUserList[i].targetId, depart_id: this.nodeConfig.nodeUserList[i].name })
        ...
        for (let i in this.nodeConfig.conditionNodes[priorityLevel - 1].nodeUserList) {
          this.departlist_lookC.push({ id: this.nodeConfig.conditionNodes[priorityLevel - 1].nodeUserList[i].targetId, depart_id: this.nodeConfig.conditionNodes[priorityLevel - 1].nodeUserList[i].name, Department: this.nodeConfig.conditionNodes[priorityLevel - 1].nodeUserList[i].department })
        }
        console.log(this.nodeConfig)
        console.log(this.departlist_lookC)
