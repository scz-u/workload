...
export default {
  ...
  mounted () {
    ...
    if (this.mycode != '123') {
      if (this.worktype == 2 && this.show_click == 2) {
        ...
        this.nodeConfig = this.sumval.threeval.nodeConfig
        this.nodeConfig.nodeUserList = nodelist
        if (this.nodeConfig.childNode != null || this.nodeConfig.childNode.length > 0) {
          if (this.nodeConfig.childNode.conditionNodes[0].priorityLevel > this.nodeConfig.childNode.conditionNodes[this.nodeConfig.childNode.conditionNodes.length - 1].priorityLevel) {
            this.nodeConfig.childNode.conditionNodes = this.nodeConfig.childNode.conditionNodes.reverse()
