    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          <!-- activeData.tagIcon !== 'image' &&
              activeData.tagIcon !== 'upload' && -->
          <el-form-item
            v-if="
          ...
          <template
            v-if="
              ['el-checkbox-group', 'el-radio-group', 'select'].indexOf(
                activeData.tagIcon
              ) > -1
            "
          >
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          ...
          >取 消</el-button
        >
        <el-button type="primary" @click="checkExpression" size="mini"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  watch: {
    ...
    activeData (val) {
      ...
      console.log('sdsdactivedata')

      if (this.activeData.str_id_list.length == 0) return

      let strlist = this.$store.state.strlist
      console.log(this.activeData.strlist)

      console.log(strlist)
      console.log(this.activeData.str_id_list)
  ...
  methods: {
    ...
    lengthClick () {
      console.log(this.activeData.maxlength)
    ...
    subBackFunc (val) {
      console.log(val)
      // this.funclist = val
      this.func_end = val.formulaStr
      this.fun_desc = val.formulaId
    ...
    checkExpression () {
      ...
      if (this.expValid) {
        this.activeData.strlist = this.expressionTemp // calcRPN(toRPN(formatExp))
