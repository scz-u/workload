...
<template>
  <div class="container13">
    <el-dialog
      ...
      class="formalert_conainer form_task_dialog"
    >
      <div class="container1">
        <div class="left-board" style="position: none">
        ...
        <div class="logo">创建表单</div>
          ...
          <div class="left-scrollbar">
            <el-tabs v-model="activeTabName" :stretch="true">
              ...
              <!-- <div class="components-list" style="height: none">
                <p class="component_title">样式控件</p>
                <draggable
                  class="components-draggable"
                  :list="readOnly"
        ...
        <div class="center-board">
          <div class="action-bar" style="top: -20px">
...
export default {
  ...
  watch: {
    ...
    "activeData.label": function (val, oldVal) {
      console.log(val)
      console.log(oldVal)
      console.log(oldActiveId)
      console.log(this.activeId)
      console.log(this.activeData.tagIcon)
      console.log(this.activeData.placeholder === undefined ||
        !this.activeData.tag ||
